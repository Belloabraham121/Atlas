import { bus, A2AMessage, ScanRequestPayload, BalanceUpdatePayload } from '../utils/bus.js';
...
export class WalletAgent {
  private agentName = 'wallet@portfolio.guard';
  ...
  private async handleScanRequest(message: A2AMessage): Promise<void> {
    try {
      ...
      const balanceUpdates: Record<string, BalanceUpdatePayload> = {};
