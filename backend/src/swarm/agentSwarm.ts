...
export class AgentSwarm {
  ...
  async initialize(): Promise<void> {
    ...
    try {
      ...
      console.log(
        "  • llm@portfolio.guard - Processes natural language with AI"
      );
      console.log(
        "  • scanner@portfolio.guard - Performs comprehensive address analysis"
      );
    } catch (error) {
  ...
  async healthCheck(): Promise<{
    ...
    const isHealthy =
      healthyCount === expectedAgents.length && this.isInitialized;
