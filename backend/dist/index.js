...
async function startServer() {
    try {
        ...
        app.listen(PORT, () => {
            console.log(`✅ PortfolioGuard Backend running: http://localhost:${PORT}`);
            console.log(`📊 Agent Swarm Status: http://localhost:${PORT}/swarm/status`);
            console.log(`🏥 Agent Swarm Health: http://localhost:${PORT}/swarm/health`);
            console.log(`💬 Chat API: POST http://localhost:${PORT}/api/:userId/chat`);
        });
    }
    catch (error) {
